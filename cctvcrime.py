...
class File(object):
    ...
    @dframe.setter
    def dframe(self, dframe) -> str: self._dframe = dframe
...
class Service(Reader):
    ...
    def save_police_pos(self):
        ...
        for name in station_names:
            ...
            station_lngs.append(t_loc['location']['lat'])
        gu_names = []
    ...
    def save_police_norm(self):
        ...
        for i in self.crime_rate_columns:
            police.loc[police[i] > 100, 1] = 100  # 데이터값의 기간오류로 100을 넘으면 100으로 계산
        ...
        police_norm.to_csv('./saved_data/police_norm', sep=',', encoding='UTF-8')
    ...
    def draw_crime_map(self):
        ...
        folium_map.choropleth(
            geo_data=seoul_geo, name='choropleth', data=tuple(zip(police_norm['구별'], police_norm['범죄'])),
            key_on='feature.id', fill_color='PuRd', fill_opacity=0.7, line_opacity=0.2,
